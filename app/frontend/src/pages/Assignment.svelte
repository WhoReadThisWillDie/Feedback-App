...
{#if assignment}
  <div class="flex flex-col grid-cols-2 gap-8 lg:grid ">
    <div>
      <div>
        <h1 class="text-xl font-bold text-textColor">{assignment.title}</h1>
    ...
    <div class="flex flex-col gap-4 text-textColor">
      <h2 class="font-medium">Transcript feedback</h2>
      <textarea
        placeholder="Type here..."
        class="w-full p-2 rounded-lg resize-none min-h-32 border-2"
      />
