...
<div class="mb-4 w-[400px]">
    ...
    <div class="flex items-center gap-2 p-4 rounded-full gradient-before gradient-border h-12 text-black">
        <Button className="!rounded-full !p-0 w-9 h-9 flex items-center justify-center" on:click={togglePlay}>
            <Icon src={!paused ? Pause : Play} solid class="text-black size-6" />
        </Button>
        <!-- Progress Bar -->
